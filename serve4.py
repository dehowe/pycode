...
class Data_manager4():
    ...
    def get_week_data(self,data):
        if len(data) != 0:
            ...
            year = data_csv.iloc[0, 4] - 2020
            week = data_csv.iloc[:, 9]
            week_index = year * 53 + week[0] + 1
            result = []
            j = 0
            for i in range(len(data_csv)):
                index = (data_csv.iloc[i, 4] - 2020) * 53 + week[i]
                if index >= week_index:
                    if index == week_index:
            ...
            w.columns = ['sline', 'trainid', 'bid', 'date', 'year', 'month', 'day', 'hour', 'min', 'week', 'qy1', 'zs1',
                         ...
                         'zs8', 'fz1', 'fz2', 'fz3', 'fz4', 'qynh', 'fznh', 'zsnl', 'lcsh', 'yxlc', 'yxlc_cab', 'cgl',
                         'rs']
        else:
    ...
    def data_manager3_auto(self,db):
        ...
        result_line1_403_week = self.get_week_data(line1_403_data)
        ...
        result_line6_009_week = self.get_week_data(line6_009_data)
        ...
        result_line7_016_week = self.get_week_data(line7_016_data)
        ...
        result_line7_032_week = self.get_week_data(line7_032_data)
        ...
        result_line8_066_week = self.get_week_data(line8_066_data)
        ...
        result_line8_079_week = self.get_week_data(line8_079_data)
        ...
        result_line13_417_week = self.get_week_data(line13_417_data)
        ...
        result_line15_031_week=self.get_week_data(line15_031_data)
        ...
        result_line17_010_week = self.get_week_data(line17_010_data)
        ...
        result_line21_019_week = self.get_week_data(line21_019_data)
        ...
        result_line21_001_week = self.get_week_data(line21_001_data)
        ...
        result_line23_437_week = self.get_week_data(line23_437_data)
    ...
    def lineedata_week_output(self, data_df, database):  # day数据导出到表
        ...
        sqls_insert_datas = "insert into sub_edata_week(sline,trainid,bid,date,year,month,day,hour,min,week,qy1,zs1,qy2,zs2,qy3,zs3,qy4,zs4,qy5,zs5,qy6,zs6,qy7,zs7,qy8,zs8,fz1,fz2,fz3,fz4,qynh,fznh,zsnl,lcsh,yxlc,yxlc_cab,cgl,rs) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s);"
    ...
    def clear_week_table(self,db):
        sql_linex_week = 'truncate table sub_edata_week'  # 清空
