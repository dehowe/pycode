...
class Data_manager3():
    ...
    def get_data_seconds(self,data_csv):
        if len(data_csv) != 0:
            ...
            result = pd.DataFrame(columns=['qy_date', 'qy', 'zs'])
        return result
    def get_mvb_seconds(self,data_mvb):
        if len(data_mvb) != 0:
            array_to_matrix1 = np.mat(data_mvb)
            w = pd.DataFrame(array_to_matrix1)
            w.columns = ['id','date_mvb', 'date', 'mileage', 'station_now', 'station_next', 'speed', 'gradient',
                         'mc1_fullload_rate', 'mc1_noload_mass', 'm2_fullload_rate', 'm2_noload_mass',
                         'm3_fullload_rate', 'm3_noload_mass', 'm4_fullload_rate', 'm4_noload_mass', 'm5_fullload_rate',
                         'm5_noload_mass', 'mc6_fullload_rate', 'mc6_noload_mass', 'train_mass', 'mc1_motor_speed',
                         'mc1_motor_a', 'mc1_motor_v', 'mc1_motor_flag', 'm2_motor_speed', 'm2_motor_a', 'm2_motor_v',
                         'm2_motor_flag', 'm3_motor_speed', 'm3_motor_a', 'm3_motor_v', 'm3_motor_flag',
                         'm4_motor_speed', 'm4_motor_a', 'm4_motor_v', 'm4_motor_flag', 'm5_motor_speed', 'm5_motor_a',
                         'm5_motor_v', 'm5_motor_flag', 'mc6_motor_speed', 'mc6_motor_a', 'mc6_motor_v',
                         'mc6_motor_flag', 'tra_force', 'mc1_ebf', 'm2_ebf', 'm3_ebf', 'm4_ebf', 'm5_ebf', 'mc6_ebf',
                         'mc1_abf', 'm2_abf', 'm3_abf', 'm4_abf', 'm5_abf', 'mc6_abf', 'motor_tem']

            result_mvb_s = w.drop(['id','date_mvb', 'speed', 'gradient', 'mc1_fullload_rate', 'mc1_noload_mass',
                                   'm2_fullload_rate', 'm2_noload_mass', 'm3_fullload_rate', 'm3_noload_mass',
                                   'm4_fullload_rate', 'm4_noload_mass',
                                   'm5_fullload_rate', 'm5_noload_mass', 'mc6_fullload_rate', 'mc6_noload_mass',
                                   'mc1_motor_speed', 'mc1_motor_a','station_now','station_next',
                                   'mc1_motor_v', 'mc1_motor_flag', 'm2_motor_speed', 'm2_motor_a', 'm2_motor_v',
                                   'm2_motor_flag', 'm3_motor_speed', 'm3_motor_a',
                                   'm3_motor_v', 'm3_motor_flag', 'm4_motor_speed', 'm4_motor_a', 'm4_motor_v',
                                   'm4_motor_flag', 'm5_motor_speed', 'm5_motor_a',
                                   'm5_motor_v', 'm5_motor_flag', 'mc6_motor_speed', 'mc6_motor_a', 'mc6_motor_v',
                                   'mc6_motor_flag', 'tra_force', 'mc1_ebf', 'm2_ebf',
                                   'm3_ebf', 'm4_ebf', 'm5_ebf', 'mc6_ebf', 'mc1_abf', 'm2_abf', 'm3_abf', 'm4_abf',
                                   'm5_abf', 'mc6_abf', 'motor_tem'], axis=1)
            result_mvb_s['yxlc_mvb'] = abs(result_mvb_s['mileage'].diff(-1))
            result_mvb_s=result_mvb_s.fillna(0)
            result_mvb_s['rs_mvb'] = round(abs(result_mvb_s['train_mass'] - 13660) / 6,2)
            result_mvb_s = result_mvb_s.drop(['mileage', 'train_mass'], axis=1)
        else:
            result_mvb_s = pd.DataFrame(columns=['date', 'yxlc_mvb', 'rs_mvb'])
        return result_mvb_s
    ...
    def get_line23_437_data(self,db): #13号线数据提取日能耗提取
        ...
        return result4_s,result4
    def get_line17_010_data(self,db): #13号线数据提取日能耗提取
        print('读取数据中..')
        linexdata_qy1_sql = "select * from ys_line17_010_qy1data"
        linexdata_qy1 = self.get_mysql_data(linexdata_qy1_sql, db)
        linexdata_qy2_sql = "select * from ys_line17_010_qy2data"
        linexdata_qy2 = self.get_mysql_data(linexdata_qy2_sql, db)
        linexdata_qy3_sql = "select * from ys_line17_010_qy3data"
        linexdata_qy3 = self.get_mysql_data(linexdata_qy3_sql, db)
        linexdata_qy4_sql = "select * from ys_line17_010_qy4data"
        linexdata_qy4 = self.get_mysql_data(linexdata_qy4_sql, db)
        linexdata_qy5_sql = "select * from ys_line17_010_qy5data"
        linexdata_qy5 = self.get_mysql_data(linexdata_qy5_sql, db)
        linexdata_qy6_sql = "select * from ys_line17_010_qy6data"
        linexdata_qy6 = self.get_mysql_data(linexdata_qy6_sql, db)

        linexdata_fz1_sql = "select * from ys_line17_010_fz1data"
        linexdata_fz1 = self.get_mysql_data(linexdata_fz1_sql, db)
        linexdata_fz2_sql = "select * from ys_line17_010_fz2data"
        linexdata_fz2 = self.get_mysql_data(linexdata_fz2_sql, db)
        linexdata_fz3_sql = "select * from ys_line17_010_fz3data"
        linexdata_fz3 = self.get_mysql_data(linexdata_fz3_sql, db)
        linexdata_fz4_sql = "select * from ys_line17_010_fz4data"
        linexdata_fz4 = self.get_mysql_data(linexdata_fz4_sql, db)
        linexdata_fz5_sql = "select * from ys_line17_010_fz5data"
        linexdata_fz5 = self.get_mysql_data(linexdata_fz5_sql, db)
        linexdata_fz6_sql = "select * from ys_line17_010_fz6data"
        linexdata_fz6 = self.get_mysql_data(linexdata_fz6_sql, db)
        linexdata_mvb_sql = "select * from ys_line17_010_mvbdata"
        linexdata_mvb = self.get_mysql_data(linexdata_mvb_sql, db)
        print('处理中..')
        result_qy1_s = self.get_data_seconds(linexdata_qy1)
        result_qy1_s.columns = ['qy1_date', 'qy1', 'zs1']
        result_qy1_s = result_qy1_s.set_index('qy1_date')
        ...
        result_fz1_s = self.get_data_seconds(linexdata_fz1)
        result_fz1_s.columns = ['fz1_date', 'fz11', 'fz1zs']
        result_fz1_s = result_fz1_s.set_index('fz1_date')
        result_fz1_s = result_fz1_s.drop(['fz1zs'], axis=1)
        result_fz2_s = self.get_data_seconds(linexdata_fz2)
        result_fz2_s.columns = ['fz2_date', 'fz22', 'fz2zs']
        result_fz2_s = result_fz2_s.set_index('fz2_date')
        result_fz2_s = result_fz2_s.drop(['fz2zs'], axis=1)
        result_fz3_s = self.get_data_seconds(linexdata_fz3)
        result_fz3_s.columns = ['fz3_date', 'fz3', 'fz3zs']
        result_fz3_s = result_fz3_s.set_index('fz3_date')
        result_fz3_s = result_fz3_s.drop(['fz3zs'], axis=1)
        result_fz4_s = self.get_data_seconds(linexdata_fz4)
        result_fz4_s.columns = ['fz4_date', 'fz4', 'fz4zs']
        result_fz4_s = result_fz4_s.set_index('fz4_date')
        result_fz4_s = result_fz4_s.drop(['fz4zs'], axis=1)
        result_fz5_s = self.get_data_seconds(linexdata_fz5)
        result_fz5_s.columns = ['fz5_date', 'fz5', 'fz5zs']
        result_fz5_s = result_fz5_s.set_index('fz5_date')
        result_fz5_s = result_fz5_s.drop(['fz5zs'], axis=1)
        result_fz6_s = self.get_data_seconds(linexdata_fz6)
        result_fz6_s.columns = ['fz6_date', 'fz6', 'fz6zs']
        result_fz6_s = result_fz6_s.set_index('fz6_date')
        result_fz6_s = result_fz6_s.drop(['fz6zs'], axis=1)

        result_mvb_s = self.get_mvb_seconds(linexdata_mvb)
        result_mvb_s.columns = ['mvb_date', 'yxlc_mvb', 'rs_mvb']
        result_mvb_s = result_mvb_s.set_index('mvb_date')

        # 合并
        result1_s = result_qy1_s.join(result_qy2_s, how='outer')
        result2_s = result1_s.join(result_qy3_s, how='outer')
        result3_s = result2_s.join(result_qy4_s, how='outer')
        result4_s = result3_s.join(result_qy5_s, how='outer')
        result5_s = result4_s.join(result_qy6_s, how='outer')
        result6_s = result5_s.join(result_fz1_s, how='outer')
        result7_s = result6_s.join(result_fz2_s, how='outer')
        result8_s = result7_s.join(result_fz3_s, how='outer')
        result9_s = result8_s.join(result_fz4_s, how='outer')
        result10_s = result9_s.join(result_fz5_s, how='outer')
        result11_s = result10_s.join(result_fz6_s, how='outer')
        result12_s = result11_s.join(result_mvb_s, how='outer')

        result12_s = result12_s.reset_index()
        result12_s.rename(columns={'qy1_date': 'date'}, inplace=True)
        result12_s = result12_s.fillna(0)
        result12_s['fz1']=result12_s['fz11']+result12_s['fz22']+result12_s['fz3']
        result12_s['fz2']=result12_s['fz4']+result12_s['fz5']+result12_s['fz6']
        result12_s = result12_s.drop(['fz11','fz22','fz3','fz4','fz5','fz6'], axis=1)

        result12_s = self.Zhanwei1(result12_s, 13, 2)
        result12_s = self.Zhanwei2(result12_s, 21, 2)
        # 计算：
        result12_s['qynh'] = result12_s['qy1'] + result12_s['qy2'] + result12_s['qy3']+result12_s['qy4'] + result12_s['qy5'] + result12_s['qy6']
        result12_s['fznh'] = result12_s['fz1'] + result12_s['fz2']
        result12_s['zsnl'] = result12_s['zs1'] + result12_s['zs2'] + result12_s['zs3']+result12_s['zs4'] + result12_s['zs5'] + result12_s['zs6']
        result12_s['lcsh'] = result12_s['qynh'] + result12_s['fznh'] - result12_s['zsnl']
        result12_s.insert(27, 'yxlc',None)
        result12_s['yxlc']=result12_s['yxlc_mvb']
        result12_s.insert(28, 'yxlc_cab', None)
        result12_s.insert(29, 'cgl', None)
        result12_s.insert(30, 'rs', None)
        result12_s['rs']=result12_s['rs_mvb']
        result12_s = result12_s.drop(['yxlc_mvb','rs_mvb'], axis=1)

        # 计算年月日
        result12_s.insert(1, 'year', None)
        result12_s.insert(2, 'month', None)
        result12_s.insert(3, 'day', None)
        result12_s.insert(4, 'hour', None)
        result12_s.insert(5, 'min', None)
        result12_s.insert(6, 'week', None)
        result12_s.insert(0, 'bid', '2')
        result12_s.insert(0, 'trainid', 'S1010')
        result12_s.insert(0, 'sline', '17')

        #提取分钟能耗
        data = result12_s.iloc[:, 3].astype(str).values
        result12_s['year'], result12_s['month'], result12_s['day'], result12_s['hour'], result12_s['min'], result12_s['week'] = self.year_change(data)
        #里程数据处理
        for i in range(len(result12_s)):
            lc=result12_s.iloc[i,34]
            if lc >2:
                result12_s.iloc[i,34]=0

        result4=self.s1_min_get(result12_s)
        return result12_s,result4

    def s1_min_get(self,data_csv):  # 整合csv
        result = []
        if(len(data_csv)>0):
            min_begin = data_csv.iloc[0, 8]
            j = 0
            min_index = -1
            index = 0
            for i in range(len(data_csv)):
                min = data_csv.iloc[i, 8]
                if (min != min_begin):
                    index = i
                    j = index
                    break
            ...
            for i in range(len(data_csv)):
                if i == min_index + index:
                    ...
                    #date = data['date'].astype(str).values
                    #data['year'], data['month'], data['day'], data['hour'], data['min'], data['week'] = self.year_change(date)
                    ...
                    data['yxlc'] = self.get_sum_data(data_csv.iloc[j:i + 1, 34].values)
        ...
        if (len(result) > 0):
            ...
            # w = pd.DataFrame(w.values.T, index=w.columns, columns=w.index)  # 转置
            data_correct_df.columns = ['sline', 'trainid', 'bid', 'date', 'year', 'month', 'day', 'hour', 'min', 'week', 'qy1', 'zs1',
                         'qy2', 'zs2', 'qy3', 'zs3', 'qy4', 'zs4', 'qy5', 'zs5', 'qy6', 'zs6', 'qy7', 'zs7', 'qy8', 'zs8',
                         'fz1', 'fz2', 'fz3', 'fz4', 'qynh', 'fznh', 'zsnl', 'lcsh', 'yxlc', 'yxlc_cab', 'cgl', 'rs']
        else:
            data_correct_df = pd.DataFrame(
                columns=['sline', 'trainid', 'bid', 'date', 'year', 'month', 'day', 'hour', 'min', 'week', 'qy1', 'zs1',
                         'qy2', 'zs2', 'qy3', 'zs3', 'qy4', 'zs4', 'qy5', 'zs5', 'qy6', 'zs6', 'qy7', 'zs7', 'qy8',
                         'zs8',
                         'fz1', 'fz2', 'fz3', 'fz4', 'qynh', 'fznh', 'zsnl', 'lcsh', 'yxlc', 'yxlc_cab', 'cgl', 'rs'])
        return data_correct_df
    ...
    def get_hour_data(self,data_csv):
        if(len(data_csv)!=0):
            ...
            if (len(result) > 0):
                ...
                w = pd.DataFrame(columns=['sline', 'trainid', 'bid', 'date', 'year', 'month', 'day', 'hour', 'min', 'week', 'qy1',
                             'zs1',
                             'qy2', 'zs2', 'qy3', 'zs3', 'qy4', 'zs4', 'qy5', 'zs5', 'qy6', 'zs6', 'qy7', 'zs7', 'qy8',
                             'zs8',
    ...
    def data_manager3_auto(self,db):
        ...
        result_line1_S403_hour = self.get_hour_data(result_line1_S403_min)
        result_line1_S403_day = self.get_day_data(result_line1_S403_min)
        ...
        print('处理line17_010中..') #磁浮S1线
        result_line17_010_s, result_line17_010_min = self.get_line17_010_data(db)
        result_line17_010_hour = self.get_hour_data(result_line17_010_min)
        result_line17_010_day = self.get_day_data(result_line17_010_min)
        self.linedata_s_output_div(result_line17_010_s, db)
        self.linedata_min_output_div(result_line17_010_min, db)
        self.linedata_hour_output_div(result_line17_010_hour, db)
        self.linedata_day_output_div(result_line17_010_day, db)
    ...
    def clear_all_table(self,db):  #清空缓存表
        ...
        db.clear_table(sql_line23_437)
        #磁浮S1线
        sql_line17_010 = 'truncate table ys_line17_010_qy1data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_qy2data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_qy3data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_qy4data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_qy5data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_qy6data'
        db.clear_table(sql_line17_010)

        sql_line17_010 = 'truncate table ys_line17_010_fz1data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_fz2data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_fz3data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_fz4data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_fz5data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_fz6data'
        db.clear_table(sql_line17_010)

        sql_line17_010 = 'truncate table ys_line17_010_xf1data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_xf2data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_xf3data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_xf4data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_xf5data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_xf6data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_xf6data'
        db.clear_table(sql_line17_010)
        sql_line17_010 = 'truncate table ys_line17_010_mvbdata'
        db.clear_table(sql_line17_010)
